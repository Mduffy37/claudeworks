      ...
      <div className="pe-topbar-identity">
        <div className="pe-topbar-name-row">
          <input
            ...
            placeholder={isNew ? namePlaceholder : ""}
            autoFocus={isNew}
          />
          {dirty && !isNew && (
            <span
        ...
        <span className="pe-topbar-subtitle">{subtitleText}</span>
      </div>
              ...
              <div className="pe-topbar-secondary">
                ...
                {showOverflow && (
                  <>
                    ...
                    >
                      {overflowMenu(() => setShowOverflow(false))}
                    </div>
                  </>
                )}
              </div>
              ...
              <>
                ...
                {showLaunchOptions && (
                  <LaunchOptionsPopover
                    defaultDangerous={launchPopoverProps?.defaultDangerous}
                    showTmux={launchPopoverProps?.showTmux}
