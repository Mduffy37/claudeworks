...
const api: ElectronAPI = {
  ...
  updateMarketplace: (name) => ipcRenderer.invoke("update-marketplace", name),
  updateAllMarketplaces: () => ipcRenderer.invoke("update-all-marketplaces"),
  ...
  getCuratedIndex: () => ipcRenderer.invoke("get-curated-index"),
  refreshCuratedIndex: () => ipcRenderer.invoke("refresh-curated-index"),
